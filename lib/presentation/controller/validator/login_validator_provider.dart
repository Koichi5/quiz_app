...
import '../../../domain/entity/login_entity/login_entity.dart';
...
class LoginValidatorProvider extends StateNotifier<LoginFormState> {
  LoginValidatorProvider() : super(LoginFormState(LoginEntity.empty()));

  void setEmail(String email) {
    final bool isEmail = RegExp(r"^[a-zA-Z0-9.a-zA-Z0-9.!#$%&'*+-/=?^_`{|}~]+@[a-zA-Z0-9]+\.[a-zA-Z]+").hasMatch(email);
    LoginEntity form = state.form.copyWith(email: Field(value: email));
  ...
  void setPassword(String password) {
    ...
    LoginEntity form = state.form.copyWith(password: Field(value: password));
