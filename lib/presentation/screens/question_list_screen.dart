...
//
// class QuestionListScreen extends HookConsumerWidget {
//   const QuestionListScreen({required this.quiz, Key? key}) : super(key: key);
//
//   final Quiz quiz;
//
//   @override
//   Widget build(BuildContext context, WidgetRef ref) {
//     final questionState = ref.watch(questionControllerProvider(quiz));
//     // final optionState = ref.watch(optionControllerProvider(quiz));
...
//         children: [
//           questionState.when(
//               data: (questions) => questions.isEmpty ? const Center(
//                 child: Text("問題はありません"),
//               ) : ListView.builder(
//                 shrinkWrap: true,
